...
export enum ErrorCode {
  ...
  WORKSPACE_HAS_ACTIVE_TASKS = 'WORKSPACE_HAS_ACTIVE_TASKS',
  ...
  MEMBER_HAS_ACTIVE_TASKS = 'MEMBER_HAS_ACTIVE_TASKS',
  ...
  // ProjectMember errors (PROJECT_MEMBER_xxx)
  PROJECT_MEMBER_NOT_FOUND = 'PROJECT_MEMBER_NOT_FOUND',
  PROJECT_MEMBER_ALREADY_EXISTS = 'PROJECT_MEMBER_ALREADY_EXISTS',
  PROJECT_MEMBER_CANNOT_CHANGE_ADMIN = 'PROJECT_MEMBER_CANNOT_CHANGE_ADMIN',
  PROJECT_MEMBER_CANNOT_REMOVE_ADMIN = 'PROJECT_MEMBER_CANNOT_REMOVE_ADMIN',
  PROJECT_MEMBER_HAS_ACTIVE_TASKS = 'PROJECT_MEMBER_HAS_ACTIVE_TASKS',
  ...
  TASK_DELETE_STATUS_FORBIDDEN = 'TASK_DELETE_STATUS_FORBIDDEN',
  ...
  ADMIN_CANNOT_BLOCK_SELF = 'ADMIN_CANNOT_BLOCK_SELF',
